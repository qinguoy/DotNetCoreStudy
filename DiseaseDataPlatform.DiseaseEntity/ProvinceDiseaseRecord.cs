...
{
    public class ProvinceDiseaseRecord
    {

        [Key]
        public Guid Id { get; set; }

        public Guid CountryDiseaseRecordId { get; set; }
        [ForeignKey("CountryDiseaseRecordId")]
        public CountryDiseaseRecord CountryDiseaseRecord { get; set; }
        [MaxLength(100)]
        ...
        public List<CityDiseaseRecord> CityDiseaseRecordList { get; set; }
        /// <summary>
        /// 统计日期
        /// </summary>
